...
<div class="card-body">
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group row">
            <label for="nickname" class="col-md-4 col-form-label text-md-right">{{ __('Login') }}</label>
...
@if (Route::has('instant-game'))
<a class="btn btn-primary" href="{{ route('instant-game') }}">
        {{ __('Szybka gra') }}
    </a>
    @endif
    <a class="btn btn-primary" href="{{ route('ranking') }}">
        {{ __('Ranking') }}
    </a>
